...
use App\Models\Categoria as ModelsCategorias;
...
class Categorias extends Component
{
    ...
    public function submitForm()
    {
        ...
        try {
            ...
            ModelsCategorias::updateOrCreate([
                'id' => $this->editId
            ],[
                'nombre' => $this->nombre,
            ]);
    ...
    public function estatusSubmit()
    {
        DB::beginTransaction();
        try {
            $data = ModelsCategorias::find($this->statusId);
    ...
    public function deleteSubmit()
    {
        ...
        DB::beginTransaction();
        try {
            ModelsCategorias::find($this->delteId)->delete();
    ...
    {
        $collection = ModelsCategorias::query();
        ...
        return view('livewire.modules.catalogos.categorias', [
