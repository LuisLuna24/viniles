...
class Maquinas extends Component
{
    ...
    public function estatusSubmit()
    {
        DB::beginTransaction();
        try {
            $data = Maquina::finMaquina($this->statusId);
    ...
    public function deleteSubmit()
    {
        ...
        DB::beginTransaction();
        try {
            Maquina::find($this->delteId)->delete();
    ...
    public function render()
    {
        ...
        return view('livewire.modules.catalogos.maquinas',[
