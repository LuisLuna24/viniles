...
class Configuraciones extends Component
{
    ...
    {
        $this->validate([
            'nombre' => ['required', 'max:100', Rule::unique('categorias')->ignore($this->editId),],
        ]);
    }
    ...
    public function submitForm()
    {
        ...
        try {
            ...
            ModelsConfiguraciones::updateOrCreate([
                'id' => $this->editId
            ], [
                'nombre' => $this->nombre,
            ]);
    ...
    public function render()
    {
        ...
        return view('livewire.modules.catalogos.configuraciones', [
