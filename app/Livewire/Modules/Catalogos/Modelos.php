...
class Modelos extends Component
{
    ...
    public function estatusSubmit()
    {
        DB::beginTransaction();
        try {
            $data = ModelsModelos::find($this->statusId);
    ...
    public function deleteSubmit()
    {
        ...
        DB::beginTransaction();
        try {
            ModelsModelos::find($this->delteId)->delete();
    ...
    {
        $collection = ModelsModelos::query();
        ...
        return view('livewire.modules.catalogos.modelos', [
