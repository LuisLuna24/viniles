...
use App\Models\configuraciones as ModelsConfiguraciones;
...
class Index extends Component
{
    ...
    {
        return redirect()->route('admin.configuraciones.create');
    }

    public function edit($id)
    {
        return redirect()->route('admin.configuraciones.edit', ['id' => $id]);
    }
    ...
    public function statusRegister($id)
    {
        ...
        $data = ModelsConfiguraciones::find($id);
        $this->statusId = $id;
    ...
    public function estatusSubmit()
    {
        DB::beginTransaction();
        try {
            $data = ModelsConfiguraciones::find($this->statusId);
    ...
    public function view($id)
    {
        $this->viewModal = true;
        $data = ModelsConfiguraciones::find($id);
        $this->listConfig = $data->descripciones;
    }
    //*================================================================================================================================= Eliminar
    ...
    public function deleteSubmit()
    {
        ...
        DB::beginTransaction();
        try {
            ModelsConfiguraciones::find($this->delteId)->delete();
    ...
    {
        $collection = ModelsConfiguraciones::query();
        ...
        return view('livewire.modules.configuraciones.index', [
