<footer class="" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-4">
                <h1 class="text-3xl font-black leading-tight font-marker">
                    <span class="text-white">TWO</span> <span class="text-amber-400">BROTHERS</span>
                </h1>
            ...
            <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                    ...
                    <div>
                        ...
                        <ul role="list" class="mt-6 space-y-4">
                            <li><a href="{{ route('home') }}"
                                    class="text-sm leading-6 text-gray-300 hover:text-amber-400 transition-colors">Inicio</a>
                            </li>
                            <li><a href="{{ route('productos') }}"
                                    class="text-sm leading-6 text-gray-300 hover:text-amber-400 transition-colors">Productos</a>
                            </li>
                            <li><a href="{{ route('nosotros') }}"
                                    class="text-sm leading-6 text-gray-300 hover:text-amber-400 transition-colors">Nosotros</a>
                            </li>
                            <li><a href="{{ route('contacto') }}"
                                    class="text-sm leading-6 text-gray-300 hover:text-amber-400 transition-colors">Contacto</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        <h3 class="text-sm font-semibold leading-6 text-white">Síguenos</h3>
                        <div class="flex items-center space-x-6 mt-6">
                            <a href="https://www.instagram.com/twobroters1440"
                                class="text-gray-400 hover:text-amber-400 transition-colors"><span
        ...
        <div
            class="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 flex flex-col items-center gap-4 sm:flex-row sm:justify-between">

            <p class="text-xs leading-5 text-gray-400">&copy; {{ date('Y') }} Two Brothers. Todos los derechos
                reservados.</p>

            <p class="text-xs leading-5 text-gray-400">
                Desarrollado por
                <a href="https://lunaweb.com.mx" target="_blank" rel="noopener noreferrer"
                    class="font-semibold text-gray-300 hover:text-amber-400 transition-colors">Luna Web</a>.
            </p>
