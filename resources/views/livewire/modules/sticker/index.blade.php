<div>
    ...
    <x-table.table>
        <x-slot name="titles">
            ...
            <x-table.th>Largo</x-table.th>
            <x-table.th>Alto</x-table.th>
            <x-table.th>Colores</x-table.th>
        ...
        <x-slot name="rows">
            @forelse ($collection as $index => $item)
                <x-table.tr>
                    ...
                    <x-table.td>{{ $item->largo }}</x-table.td>
                    <x-table.td>{{ $item->alto }}</x-table.td>
                    <x-table.td>{{ $item->colores }}</x-table.td>
                    <x-table.td>
