        ...
        <x-slot name="rows">
            @forelse ($collection as $index => $item)
                <x-table.tr>
                    ...
                    <x-table.td>{{ $item->marca ?? 'S/M' }}</x-table.td>
                    <x-table.td>{{ $item->modelo ?? 'S/M' }}</x-table.td>
                    <x-table.td>
            ...
            <form wire:submit="submitForm">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div class="flex flex-col gap-1 md:col-span-2">
                        <label for="nombre">Nombre: <span class="opacity-50">(Obligatorio)</span></label>
                        <x-input wire:model="nombre" id="nombre" />
                        <x-input-error for="nombre" />
                    </div>
                    <div class="flex flex-col gap-1 md:col-span-2">
                        <label for="marca">Marca:</label>
                        <x-input wire:model="marca" id="marca" />
                        <x-input-error for="marca" />
                    </div>
                    <div class="flex flex-col gap-1 md:col-span-2">
                        <label for="modelo">Modelo:</label>
                        <x-input wire:model="modelo" id="modelo" />
